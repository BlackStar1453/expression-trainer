 ...
 * The user speaks English; for each finished sentence we ask the model whether
 * it is correct & natural, and if not, return a structured correction.
 *
...
module.exports = { getRealtimePrompt, getReportPrompt, getCorrectionPrompt };
